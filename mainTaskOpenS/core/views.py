...
def login_user(request):
    return render(request, 'login.html') #chamamos login.html

# quando o batao é apertado tudo o que esta dento de form no ficheiro
#html é passado como parametro aqui
@csrf_protect
def submit_login(request):
    if request.POST:
        ...
        if user is not None:
            ...
            messages.error(request, 'User or password invalid. Please ty again.')
    return redirect('/login/')
